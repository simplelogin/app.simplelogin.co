...
(function () {
  ...
  var apiPrefix = 'https://simplelogin-api.herokuapp.com/v1/';
  ...
  /* Templates */
  var tmpLogin = '<form class="form-signin"><h2 class="form-heading"><img src="/img/logotipo-60.png"></h2><div class="form-group"><input type="email" id="email" placeholder="Email" autocomplete="off" autofocus="true" class="form-control" required></div><div class="form-group"><input type="password" id="password" placeholder="' + $.i18n._('Password') + '" class="form-control" required></div><div class="checkbox"><label><input type="checkbox" id="login-remember"> ' + $.i18n._('Remember email') + '</label></div><button type="submit" id="login-submit" class="btn btn-block btn-primary" data-loading-text="Loading...">' + $.i18n._('Login') + '</button><hr>' + $.i18n._('Don\'t have an account') + '? <a href="#join">' + $.i18n._('Sign Up') +'</a></form>';
  var tmpJoin = '<form class="form-signup"><h2 class="form-heading"><img src="/img/logotipo-60.png"></h2><div class="form-group"><input type="email" id="email" placeholder="Email" class="form-control" autocomplete="off" autofocus="true" required></div><div class="form-group"><input type="password" id="password" placeholder="' + $.i18n._('Password') + '" class="form-control" data-toggle="popover" data-trigger="focus" data-placement="top" data-html="true" data-content="<small>10 ' + $.i18n._('characters or more.<br>Use letters (uppercase and lowercase), numbers and special characters.<br>It will be the last strong password you\'ll have to remember') + '. <i class=fa fa-thumbs-o-up></i></small>" title="'+ $.i18n._('Security') + '" required></div><div class="form-group"><input type="password" id="passwordRepeat" placeholder="' + $.i18n._('Repeat Password') + '" class="form-control" required></div><div class="progress progress-striped active"><div class="progress-bar progress-bar-danger"  role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%"><span class="sr-only"></span></div></div><div class="form-group row"><div class="col-xs-6"><input type="text" id="fname" placeholder="' + $.i18n._('First Name') + '" class="form-control" required></div><div class="col-xs-6"><input type="text" id="lname" placeholder="' + $.i18n._('Last Name') + '" class="form-control" required></div></div><p><button type="submit" id="join-submit" class="btn btn-block btn-primary" data-loading-text="Loading...">' + $.i18n._('Sign Up') + '</button></p><hr>' + $.i18n._('Already have an account') +'? <a href="#login">' + $.i18n._('Login') + '</a></form>';
  var tmpHome = '<header id="header" class="navbar navbar-default navbar-fixed-top" role="navigation"><div class="container"><div class="navbar-header"><button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a href="#" class="navbar-brand"><img src="/img/logotipo-60.png"></a></div><div class="collapse navbar-collapse" id="navbar-collapse"><ul class="nav navbar-nav navbar-right"><% if (!premium) { %><li><a href="#gifts"><i class="fa fa-gift"></i> ' + $.i18n._('Free Benefits') + '</a></li><% } %><li><a href="#" id="btn-new-credential"><i class="fa fa-plus"></i> ' + $.i18n._('Add Credential') + '</a></li><li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><%- name %> <b class="caret"></b></a><ul class="dropdown-menu"><li><a href="#settings"><i class="fa fa-cogs"></i> ' + $.i18n._('Settings') + '</a></li><% if (!premium) { %><li><a href="#upgrade"><i class="fa fa-arrow-circle-up"></i> ' + $.i18n._('Go PRO') + '</a></li><% } %><li class="divider"></li><li><a href="#logout"><i class="fa fa-sign-out"></i> ' + $.i18n._('Logout') + '</a></li></ul></li></ul></div></div></header><div id="content"><div id="home" class="container"><div class="toolbar pull-right"></div><div class="credential-groups container"><div class="row"><div class="col-md-3"><div class="tile thumbnail" data-page="group/favorites"><i class="fa fa-star"></i><h3 class="tile-title ellipsis">' + $.i18n._('Favorites') + '</h3></div></div><div class="col-md-3"><div class="tile thumbnail" data-page="group/all"><i class="fa fa-list-ul"></i><h3 class="tile-title ellipsis">' + $.i18n._('All') + '</h3></div></div><% _.each(groups, function (group) { %><div class="col-md-3" title="<%- group.description %>"><div class="tile thumbnail" data-page="group/<%- group._id %>"><i class="fa fa-th"></i><h3 class="tile-title ellipsis"><%- group.name %></h3></div></div><% }) %><div id="btn-new-group" class="col-md-3"><div class="tile thumbnail"><i class="fa fa-plus-circle"></i><h3 class="tile-title ellipsis">' + $.i18n._('Add Group') + '</h3></div></div></div></div></div></div>';
  var tmpGroupList = '<div id="list" class="container"><div class="toolbar"><% if (!blocked) { %><div class="pull-right"><div class="btn-group"><button class="btn btn-large dropdown-toggle" data-toggle="dropdown">' + $.i18n._('Options') + ' <span class="caret"></span></button><ul id="groupOptions" class="dropdown-menu"><li><a href="#" id="group-edit"><i class="fa fa-edit"></i> ' + $.i18n._('Edit Group') + '</a></li><li><a href="#" id="group-remove"><i class="fa fa-trash-o"></i> ' + $.i18n._('Remove Group') + '</a></li></ul></div></div><% } %><h3><i class="fa fa-list-ul"></i> <span id="group-name"><%- name %></span></h3></div><h3 id="no-items" class="text-muted <% if (items.length > 0) { %>hide<% } %>">' + $.i18n._('No credentials yet') + '... :(</h3><table class="table table-striped table-bordered <% if (items.length === 0) { %>hide<% } %>" style="background-color:#fff;margin-top:20px"><tbody><% _.each(items, function (item) { %><tr id="<%- item._id %>"><td><h4 class="favorite pull-left text-muted <% if (item.favorite) { %>favorited<% } %>" title="' + $.i18n._('Favorite') + '" data-id="<%- item._id %>"><i class="fa fa-star"></i></h4><h4 class="item" data-id="<%- item._id %>"><span><%- item.title %></span><% if (item.username) { %> <small class="text-muted">(<%- item.username %>)</small><% } %></h4></td></tr><% }); %></tbody></table></div>';
  var tmpSettings = '<div id="settings" class="container"><div class="alert alert-success hide"><button type="button" class="close" data-dismiss="alert">×</button><strong>' + $.i18n._('Success!') + '</strong> ' + $.i18n._('Your settings are saved correctly') + '.</div><div><legend><i class="fa fa-info-circle"></i> ' + $.i18n._('Account Info') + '</legend><div class="form-group"><label for="inputUsername">' + $.i18n._('Username') + '</label><input type="email" id="inputUsername" class="form-control" value="<%- username %>" disabled></div><div class="form-group"><label for="inputEmail">Email</label><input type="email" id="inputEmail" class="form-control" placeholder="Email" value="<%- email %>"></div><div class="form-group"><label for="inputLang">' + $.i18n._('Language') + '</label><select id="inputLang" class="form-control" name="inputLang"><option value="es">' + $.i18n._('Spanish') + '</option><option value="en">' + $.i18n._('English') + '</option></select></div><legend><i class="fa fa-user"></i> ' + $.i18n._('Profile') + '</legend><div class="form-group"><label for="inputFirstname">' + $.i18n._('First Name') + '</label><input type="text" id="inputFirstname" class="form-control" placeholder="' + $.i18n._('First Name') + '" value="<%- name.first %>"></div><div class="form-group"><label for="inputLastname">' + $.i18n._('Last Name') + '</label><input type="text" id="inputLastname" class="form-control" placeholder="' + $.i18n._('Last Name') + '" value="<%- name.last %>"></div><div class="form-group"><label for="inputGen">' + $.i18n._('Gender') + '</label><select id="inputGen" class="form-control" name="inputGen"><option value="">' + $.i18n._('Select') + '</option><option value="F">' + $.i18n._('Female') + '</option><option value="M">' + $.i18n._('Male') + '</option></select></div><div class="form-group"><label for="inputCountry">' + $.i18n._('Country') + '</label><select name="inputCountry" id="inputCountry" class="form-control"><option value="">' + $.i18n._('Select') + '</option><option value="United States">United States</option><option value="United Kingdom">United Kingdom</option><option value="Afghanistan">Afghanistan</option><option value="Albania">Albania</option><option value="Algeria">Algeria</option><option value="American Samoa">American Samoa</option><option value="Andorra">Andorra</option><option value="Angola">Angola</option><option value="Anguilla">Anguilla</option><option value="Antarctica">Antarctica</option><option value="Antigua and Barbuda">Antigua and Barbuda</option><option value="Argentina">Argentina</option><option value="Armenia">Armenia</option><option value="Aruba">Aruba</option><option value="Australia">Australia</option><option value="Austria">Austria</option><option value="Azerbaijan">Azerbaijan</option><option value="Bahamas">Bahamas</option><option value="Bahrain">Bahrain</option><option value="Bangladesh">Bangladesh</option><option value="Barbados">Barbados</option><option value="Belarus">Belarus</option><option value="Belgium">Belgium</option><option value="Belize">Belize</option><option value="Benin">Benin</option><option value="Bermuda">Bermuda</option><option value="Bhutan">Bhutan</option><option value="Bolivia">Bolivia</option><option value="Bosnia and Herzegovina">Bosnia and Herzegovina</option><option value="Botswana">Botswana</option><option value="Bouvet Island">Bouvet Island</option><option value="Brazil">Brazil</option><option value="British Indian Ocean Territory">British Indian Ocean Territory</option><option value="Brunei Darussalam">Brunei Darussalam</option><option value="Bulgaria">Bulgaria</option><option value="Burkina Faso">Burkina Faso</option><option value="Burundi">Burundi</option><option value="Cambodia">Cambodia</option><option value="Cameroon">Cameroon</option><option value="Canada">Canada</option><option value="Cape Verde">Cape Verde</option><option value="Cayman Islands">Cayman Islands</option><option value="Central African Republic">Central African Republic</option><option value="Chad">Chad</option><option value="Chile">Chile</option><option value="China">China</option><option value="Christmas Island">Christmas Island</option><option value="Cocos (Keeling) Islands">Cocos (Keeling) Islands</option><option value="Colombia">Colombia</option><option value="Comoros">Comoros</option><option value="Congo">Congo</option><option value="Congo, The Democratic Republic of The">Congo, The Democratic Republic of The</option><option value="Cook Islands">Cook Islands</option><option value="Costa Rica">Costa Rica</option><option value="Cote D\'ivoire">Cote D\'ivoire</option><option value="Croatia">Croatia</option><option value="Cuba">Cuba</option><option value="Cyprus">Cyprus</option><option value="Czech Republic">Czech Republic</option><option value="Denmark">Denmark</option><option value="Djibouti">Djibouti</option><option value="Dominica">Dominica</option><option value="Dominican Republic">Dominican Republic</option><option value="Ecuador">Ecuador</option><option value="Egypt">Egypt</option><option value="El Salvador">El Salvador</option><option value="Equatorial Guinea">Equatorial Guinea</option><option value="Eritrea">Eritrea</option><option value="Estonia">Estonia</option><option value="Ethiopia">Ethiopia</option><option value="Falkland Islands (Malvinas)">Falkland Islands (Malvinas)</option><option value="Faroe Islands">Faroe Islands</option><option value="Fiji">Fiji</option><option value="Finland">Finland</option><option value="France">France</option><option value="French Guiana">French Guiana</option><option value="French Polynesia">French Polynesia</option><option value="French Southern Territories">French Southern Territories</option><option value="Gabon">Gabon</option><option value="Gambia">Gambia</option><option value="Georgia">Georgia</option><option value="Germany">Germany</option><option value="Ghana">Ghana</option><option value="Gibraltar">Gibraltar</option><option value="Greece">Greece</option><option value="Greenland">Greenland</option><option value="Grenada">Grenada</option><option value="Guadeloupe">Guadeloupe</option><option value="Guam">Guam</option><option value="Guatemala">Guatemala</option><option value="Guinea">Guinea</option><option value="Guinea-bissau">Guinea-bissau</option><option value="Guyana">Guyana</option><option value="Haiti">Haiti</option><option value="Heard Island and Mcdonald Islands">Heard Island and Mcdonald Islands</option><option value="Holy See (Vatican City State)">Holy See (Vatican City State)</option><option value="Honduras">Honduras</option><option value="Hong Kong">Hong Kong</option><option value="Hungary">Hungary</option><option value="Iceland">Iceland</option><option value="India">India</option><option value="Indonesia">Indonesia</option><option value="Iran, Islamic Republic of">Iran, Islamic Republic of</option><option value="Iraq">Iraq</option><option value="Ireland">Ireland</option><option value="Israel">Israel</option><option value="Italy">Italy</option><option value="Jamaica">Jamaica</option><option value="Japan">Japan</option><option value="Jordan">Jordan</option><option value="Kazakhstan">Kazakhstan</option><option value="Kenya">Kenya</option><option value="Kiribati">Kiribati</option><option value="Korea, Democratic People\'s Republic of">Korea, Democratic People\'s Republic of</option><option value="Korea, Republic of">Korea, Republic of</option><option value="Kuwait">Kuwait</option><option value="Kyrgyzstan">Kyrgyzstan</option><option value="Lao People\'s Democratic Republic">Lao People\'s Democratic Republic</option><option value="Latvia">Latvia</option><option value="Lebanon">Lebanon</option><option value="Lesotho">Lesotho</option><option value="Liberia">Liberia</option><option value="Libyan Arab Jamahiriya">Libyan Arab Jamahiriya</option><option value="Liechtenstein">Liechtenstein</option><option value="Lithuania">Lithuania</option><option value="Luxembourg">Luxembourg</option><option value="Macao">Macao</option><option value="Macedonia, The Former Yugoslav Republic of">Macedonia, The Former Yugoslav Republic of</option><option value="Madagascar">Madagascar</option><option value="Malawi">Malawi</option><option value="Malaysia">Malaysia</option><option value="Maldives">Maldives</option><option value="Mali">Mali</option><option value="Malta">Malta</option><option value="Marshall Islands">Marshall Islands</option><option value="Martinique">Martinique</option><option value="Mauritania">Mauritania</option><option value="Mauritius">Mauritius</option><option value="Mayotte">Mayotte</option><option value="Mexico">Mexico</option><option value="Micronesia, Federated States of">Micronesia, Federated States of</option><option value="Moldova, Republic of">Moldova, Republic of</option><option value="Monaco">Monaco</option><option value="Mongolia">Mongolia</option><option value="Montserrat">Montserrat</option><option value="Morocco">Morocco</option><option value="Mozambique">Mozambique</option><option value="Myanmar">Myanmar</option><option value="Namibia">Namibia</option><option value="Nauru">Nauru</option><option value="Nepal">Nepal</option><option value="Netherlands">Netherlands</option><option value="Netherlands Antilles">Netherlands Antilles</option><option value="New Caledonia">New Caledonia</option><option value="New Zealand">New Zealand</option><option value="Nicaragua">Nicaragua</option><option value="Niger">Niger</option><option value="Nigeria">Nigeria</option><option value="Niue">Niue</option><option value="Norfolk Island">Norfolk Island</option><option value="Northern Mariana Islands">Northern Mariana Islands</option><option value="Norway">Norway</option><option value="Oman">Oman</option><option value="Pakistan">Pakistan</option><option value="Palau">Palau</option><option value="Palestinian Territory, Occupied">Palestinian Territory, Occupied</option><option value="Panama">Panama</option><option value="Papua New Guinea">Papua New Guinea</option><option value="Paraguay">Paraguay</option><option value="Peru">Peru</option><option value="Philippines">Philippines</option><option value="Pitcairn">Pitcairn</option><option value="Poland">Poland</option><option value="Portugal">Portugal</option><option value="Puerto Rico">Puerto Rico</option><option value="Qatar">Qatar</option><option value="Reunion">Reunion</option><option value="Romania">Romania</option><option value="Russian Federation">Russian Federation</option><option value="Rwanda">Rwanda</option><option value="Saint Helena">Saint Helena</option><option value="Saint Kitts and Nevis">Saint Kitts and Nevis</option><option value="Saint Lucia">Saint Lucia</option><option value="Saint Pierre and Miquelon">Saint Pierre and Miquelon</option><option value="Saint Vincent and The Grenadines">Saint Vincent and The Grenadines</option><option value="Samoa">Samoa</option><option value="San Marino">San Marino</option><option value="Sao Tome and Principe">Sao Tome and Principe</option><option value="Saudi Arabia">Saudi Arabia</option><option value="Senegal">Senegal</option><option value="Serbia and Montenegro">Serbia and Montenegro</option><option value="Seychelles">Seychelles</option><option value="Sierra Leone">Sierra Leone</option><option value="Singapore">Singapore</option><option value="Slovakia">Slovakia</option><option value="Slovenia">Slovenia</option><option value="Solomon Islands">Solomon Islands</option><option value="Somalia">Somalia</option><option value="South Africa">South Africa</option><option value="South Georgia and The South Sandwich Islands">South Georgia and The South Sandwich Islands</option><option value="Spain">Spain</option><option value="Sri Lanka">Sri Lanka</option><option value="Sudan">Sudan</option><option value="Suriname">Suriname</option><option value="Svalbard and Jan Mayen">Svalbard and Jan Mayen</option><option value="Swaziland">Swaziland</option><option value="Sweden">Sweden</option><option value="Switzerland">Switzerland</option><option value="Syrian Arab Republic">Syrian Arab Republic</option><option value="Taiwan, Province of China">Taiwan, Province of China</option><option value="Tajikistan">Tajikistan</option><option value="Tanzania, United Republic of">Tanzania, United Republic of</option><option value="Thailand">Thailand</option><option value="Timor-leste">Timor-leste</option><option value="Togo">Togo</option><option value="Tokelau">Tokelau</option><option value="Tonga">Tonga</option><option value="Trinidad and Tobago">Trinidad and Tobago</option><option value="Tunisia">Tunisia</option><option value="Turkey">Turkey</option><option value="Turkmenistan">Turkmenistan</option><option value="Turks and Caicos Islands">Turks and Caicos Islands</option><option value="Tuvalu">Tuvalu</option><option value="Uganda">Uganda</option><option value="Ukraine">Ukraine</option><option value="United Arab Emirates">United Arab Emirates</option><option value="United Kingdom">United Kingdom</option><option value="United States">United States</option><option value="United States Minor Outlying Islands">United States Minor Outlying Islands</option><option value="Uruguay">Uruguay</option><option value="Uzbekistan">Uzbekistan</option><option value="Vanuatu">Vanuatu</option><option value="Venezuela">Venezuela</option><option value="Viet Nam">Viet Nam</option><option value="Virgin Islands, British">Virgin Islands, British</option><option value="Virgin Islands, U.S.">Virgin Islands, U.S.</option><option value="Wallis and Futuna">Wallis and Futuna</option><option value="Western Sahara">Western Sahara</option><option value="Yemen">Yemen</option><option value="Zambia">Zambia</option><option value="Zimbabwe">Zimbabwe</option></select></div><legend><i class="fa fa-hdd-o"></i> ' + $.i18n._('Storage') + '</legend><p>' + $.i18n._('Select your trusted storage to store your data') + '. <span class="text-info storage-info" style="cursor:help" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="' + $.i18n._('For added security, you can choose where your data will be stored') + '." title="' + $.i18n._('Why') + '?"><i class="fa fa-info-circle"></i> ' + $.i18n._('Why') + '?</span></p><div class="btn-group btn-storages" data-toggle="buttons"><label class="btn btn-primary btn-simplelogin"><input type="radio" name="options" id="btn-simplelogin"> <i class="storages-simplelogin"></i> SimpleLogin</label><label class="btn btn-primary btn-dropbox"><input type="radio" name="options" id="btn-dropbox"><i class="storages-dropbox"></i> Dropbox</label></div><legend><i class="fa fa-copy"></i> ' + $.i18n._('Backups') + '</legend><div><button class="btn btn-new-backup" data-loading-text="Loading..."><i class="fa fa-plus"></i> ' + $.i18n._('New Backup') + '</button> <span class="text-success backup-message hide">' + $.i18n._('Your backup has been successfully created') + '.</span></div><% if (premium) { %><img src="/img/loader.gif" class="loader"><br><div id="backup-list" class="hide"><table class="table table-bordered table-striped"><thead><tr><th>' + $.i18n._('Date') + '</th><th style="width:67px;text-align:center;">' + $.i18n._('Actions') + '</th></tr></thead><tbody></tbody></table></div><legend><i class="fa fa-credit-card"></i> ' + $.i18n._('Billing') + '</legend><p>' + $.i18n._('Date of transaction') + ': <span class="text-success"><%- billing_date %></span></p><% } %><hr><div class="control-group"><div class="controls"><button class="btn btn-success span3 btn-save-settings">' + $.i18n._('Save') + '</button></div></div></div>';
    ...
    join: function (refUser) {
      ...
      $password
        .complexify({}, function (valid, complexity) {
          ...
          var pclass = 'progress-bar-danger';

          if (!valid) {
            pclass = 'progress-danger';
            ptext = complexity >= 25 ? $.i18n._('Weak') : $.i18n._('Very weak');

            $progress.removeClass('progress-bar-success progress-bar-warning');
          } else {
            if (complexity >= 55) {
              pclass = 'progress-bar-success';
              ptext = $.i18n._('Perfect');
            } else {
              pclass = 'progress-bar-warning';
              ptext = $.i18n._('Strong');
            }
